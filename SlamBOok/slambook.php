...
if(isset($_POST['login'])){
	...
	if(count($errors) == 0){
		...
		$db = mysqli_connect("localhost", "root", "","cse2018");
		$sql="INSERT INTO `slambook`(`FN`, `MN`, `LN`, `FUL_N`, `NIC_N`, `FAT_N`, `MOT_N`, `B_N_S_N`, `BS_F_N`, `FIRST_CN`, `KNOWME`, `HouseNumber`, `LandMark`, `City`, `District`, `State`, `Country`, `ZiPCode`, `EarthCoordinatesLN_LT`, `EmailId`, `Website`, `SkypeId`, `LinkedIn`, `Twitter`, `Google`, `Facebook`, `Eskimi`, `OtherId`, `MobileNumber`, `LandLineNumber`, `VOIP Number`, `DateOfBirth`, `ZodiacAstroSign`, `Gender`, `FavouriteColor`, `FavouriteDress`, `FavouriteMusic`, `FavouriteGame`, `FavouriteDish`, `FavouriteBook`, `FavouriteActor`, `FavouriteSportPerson`, `MoreInterestAbout`, `Thingsyoulikemostly`, `Funniestmomentinyourlife`, `Dislikedish`, `Dislikethings`, `Crazyaboutthingslike`, `Anyotherdislike`, `Whatyoulikeonme`, `Whatyoudislikeonme`, `Mostremembermomentwithme`, `Suggestionstome`, `Mostundesirablemomentbyme`, `Firstmeetwithme`, `Lifeambition`, `Inspiredby`, `Yourrolemodel`, `AboutYourSelf`)  VALUES ('$firstname','$middlename','$lastname','$fullname','$nickname','$fathername','$mothername','$bsname','$bestfriendname','$firstchildhoodfriendname','$howdidyouknowme','$doornumber','$landmark','$townname','$distict','$state','$country','$postalcode','$googleearthcoordinates','$emailid','$website','$skype','$linkedin','$twitter','$googleplus','$facebook','$eskimi','$otherid','$mobilenumber','$landlinenumber','$voipnumber','$dateofbirth','$zodiacsign','$gender','$favcolor','$favdress','$favmusic','$favgame','$favdish','$favbook','$favactor','$favsportsperson','$moreinterestabout','$thingsyoulikemostly','$funniestmoment','$dislikedish','$dislikethingst','$crazyaboutthings','$anyotherdislikes','$whatyoulikeonme','$whatyoudislikeonme','$mostremembermomentwithme','$suggestionstome','$undesirablemonentbyme','$firstmeetwithme','$lifeambition','$inspiredby','$yourrolemodel','$aboutyou')";
		...
		{
			echo "Error While Order Placeing....";
		}
	    mysqli_close($db);
		
		
		
		/*mysqli_query ("INSERT INTO `slambook`(`FN`, `MN`, `LN`, `FUL_N`, `NIC_N`, `FAT_N`, `MOT_N`, `B_N_S_N`, `BS_F_N`, `FIRST_CN`, `KNOWME`, `HouseNumber`, `LandMark`, `City`, `District`, `State`, `Country`, `ZiPCode`, `EarthCoordinatesLN_LT`, `EmailId`, `Website`, `SkypeId`, `LinkedIn`, `Twitter`, `Google`, `Facebook`, `Eskimi`, `OtherId`, `MobileNumber`, `LandLineNumber`, `VOIP Number`, `DateOfBirth`, `ZodiacAstroSign`, `Gender`, `FavouriteColor`, `FavouriteDress`, `FavouriteMusic`, `FavouriteGame`, `FavouriteDish`, `FavouriteBook`, `FavouriteActor`, `FavouriteSportPerson`, `MoreInterestAbout`, `Thingsyoulikemostly`, `Funniestmomentinyourlife`, `Dislikedish`, `Dislikethings`, `Crazyaboutthingslike`, `Anyotherdislike`, `Whatyoulikeonme`, `Whatyoudislikeonme`, `Mostremembermomentwithme`, `Suggestionstome`, `Mostundesirablemomentbyme`, `Firstmeetwithme`, `Lifeambition`, `Inspiredby`, `Yourrolemodel`, `AboutYourSelf`)  VALUES ('$firstname','$middlename','$lastname','$fullname','$nickname','$fathername','$mothername','$bsname','$bestfriendname','$firstchildhoodfriendname','$howdidyouknowme','$doornumber','$landmark','$townname','$distict','$state','$country','$postalcode','$googleearthcoordinates','$emailid','$website','$skype','$linkedin','$twitter','$googleplus','$facebook','$eskimi','$otherid','$mobilenumber','$landlinenumber','$voipnumber','$dateofbirth','$zodiacsign','$gender','$favcolor','$favdress','$favmusic','$favgame','$favdish','$favbook','$favactor','$favsportsperson','$moreinterestabout','$thingsyoulikemostly','$funniestmoment','$dislikedish','$dislikethingst','$crazyaboutthings','$anyotherdislikes','$whatyoulikeonme','$whatyoudislikeonme','$mostremembermomentwithme','$suggestionstome','$undesirablemonentbyme','$firstmeetwithme','$lifeambition','$inspiredby','$yourrolemodel','$aboutyou')");
		mysql_close();
		print mysql_error();
