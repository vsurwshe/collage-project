<html>
  ...
  <div class="container">
    ...
    <form class="myform" action="" method="post">
      <input type="text" name="username" class="inputvalue" placeholder="Username" style="text-align:center;"/> 
      <input type="password" name="password" class="inputvalue" placeholder="Password" style="text-align:center;">
    ...
    <div style="text-align: right">
     <center> <input class="button" type="submit" id="login_btn" value="Login"/></center>
	  </div>
    </form>
		</div>
	</div>
