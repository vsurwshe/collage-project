...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 27, 2018 at 09:20 AM
...
--
CREATE DATABASE IF NOT EXISTS `feedie_base` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `feedie_base`;
...
(1, 'Asarar Khan', 'CSE-BE', 'Human Computer Interaction', 'CS001', 'CSE', 67, 78, 2),
...
--
ALTER TABLE `feeds`
  MODIFY `feed_no` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
--
