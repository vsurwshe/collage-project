<?php
	...
	*/
	...
	function logOutUser(){
		...
		if(isset($_COOKIE['invoicing_rememberMe'])){
			setcookie('invoicing_rememberMe', '', time()-42000);
		}
		session_destroy();
	}
	########################################################################
	...
	function setupMembership(){
		...
		if(!$anonGroupID){
			...
			sql("insert into membership_grouppermissions set groupID='$anonGroupID', tableName='clients', allowInsert=0, allowView=0, allowEdit=0, allowDelete=0");
			sql("insert into membership_grouppermissions set groupID='$anonGroupID', tableName='invoices', allowInsert=0, allowView=0, allowEdit=0, allowDelete=0");
			sql("insert into membership_grouppermissions set groupID='$anonGroupID', tableName='invoice_items', allowInsert=0, allowView=0, allowEdit=0, allowDelete=0");
		}
		...
		if(sqlValue("select count(1) from membership_grouppermissions where groupID='$adminGroupID'")<3){
			...
			sql("insert into membership_grouppermissions set groupID='$adminGroupID', tableName='clients', allowInsert=1, allowView=3, allowEdit=3, allowDelete=3");
			sql("insert into membership_grouppermissions set groupID='$adminGroupID', tableName='invoices', allowInsert=1, allowView=3, allowEdit=3, allowDelete=3");
			sql("insert into membership_grouppermissions set groupID='$adminGroupID', tableName='invoice_items', allowInsert=1, allowView=3, allowEdit=3, allowDelete=3");
		}
