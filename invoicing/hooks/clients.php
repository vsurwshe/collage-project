<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'clients' table. 
	...
	*/
	 ...
	 *     $data['name'], $data['contact'], $data['address'], $data['phone'], $data['email'], $data['website'], $data['comments']
	...
	*/
	 ...
	 * For this table, the array items are: 
	 *     $data['id'], $data['name'], $data['contact'], $data['address'], $data['phone'], $data['email'], $data['website'], $data['comments']
