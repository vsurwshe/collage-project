	...
	<?php
		if(!$_GET['signIn'] && !$_GET['loginFailed']){
			if(is_array($arrTables)){
				if(getLoggedAdmin()){
					?><tr><td colspan="5" class="TableTitle" style="text-align: center;"><a href="admin/"><img src=table.gif border=0 align="top"></a> <a href="admin/" class="TableTitle" style="color: red;"><?php echo $Translation['admin area']; ?></a><br /><br /></td></tr><?php
				}
				foreach($arrTables as $tn=>$tc){
					...
					if(!$i){ echo '<tr>'; }
					?><td valign="top"><a href=<?php echo $tn; ?>_view.php<?php echo $searchFirst; ?>><img src=<?php echo $tc[2];?> border=0></a></td><td valign="top"><a href=<?php echo $tn; ?>_view.php<?php echo $searchFirst; ?> class="TableTitle"><?php echo $tc[0]; ?></a><br /><?php echo $tc[1]; ?></td><?php
					if(!$i){ echo '<td width="50">&nbsp;</td>'; }
					if($i){ echo '</tr>'; }
					$i=1-$i; 
				}
			}else{
...
</table><br /><br /><div class="TableFooter"><b><a href=http://www.bigprof.com/appgini/>BigProf Software</a> - <?php echo $Translation['powered by']; ?> AppGini 4.50</b></div>
